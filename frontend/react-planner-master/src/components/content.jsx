...
import StableDiffusionViewer from "./StableDiffusion-view/StableDiffusion-viewer";

export default function Content({width, height, state, customContents, ...props}) {
  ...
  switch (mode) {
    ...
    // TODO:添加SD部分页面
    case constants.MODE_VIEWING_STABLEDIFFUSION:
      return <StableDiffusionViewer state={state} width={width} height={height} {...props}/>
